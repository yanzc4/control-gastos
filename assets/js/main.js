...
function mostrarPassword(input, icon) {
...
$('#rshowPassword').click(function () {
    mostrarPassword("rpassword", "rshowPassword");
});
$('#showPassword').click(function () {
    mostrarPassword("password", "showPassword");
});

//?cambiar de loginform a registerform
...
function comprobarSimilitud(){
    ...
    var rpassword = document.getElementById('rpassr').value;
    if(password != rpassword){
        $('#cpassr').addClass('hidden');
    }else{
        $('#cpassr').removeClass('hidden');
    }
}
