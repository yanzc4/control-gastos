    ...
    <div class="swiper border-b mb-3 border-gray-200">
            <div class="swiper-wrapper pb-3">
                <div class="swiper-slide menu">
                    <button onclick="eliminarEgreso('<?php echo $i; ?>')" class="w-10 h-10 rounded-lg bg-red-100 text-red-900 hover:bg-red-200 focus:bg-red-200 flex items-center justify-center me-3 text-2xl">
